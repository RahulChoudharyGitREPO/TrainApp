...
export const validateTrain = (data) => {
  const schema = Joi.object({
    ...
    classes: Joi.array().items(
      Joi.object({
        type: Joi.string().valid("AC", "Non-AC", "Sleeper", "Seater", "First Class", "Second Class").required(),
...
export const validateBooking = (data) => {
  const schema = Joi.object({
    ...
    classType: Joi.string().valid("AC", "Non-AC", "Sleeper", "Seater", "First Class", "Second Class", "AC Chair Car", "Executive Class", "General").required(),
